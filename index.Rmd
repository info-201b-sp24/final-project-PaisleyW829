    ...
    actionButton("updatePlot", "Update Plot"),
      ...
      tabItem(tabName = "conclusions",
              fluidPage(
                ...
                h3("Takeaway 1:"),
                p("Through the analysis of the data, we calculated the Average US teen pregnancy rate. The data show that teen pregnancy rates have generally declined over the past few decades. For example, from 2000 to 2020, the teen pregnancy rate declined each year, from 62 percent in 1990-1991 to 18.1 percent in 2019-2020. This trend indicates that various education and interventions implemented in the past have had some success in reducing the teenage pregnancy rate. Widespread sex education and access to contraception are among the main factors behind these successes."),
